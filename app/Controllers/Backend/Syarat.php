...
class Syarat extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('backend/syarat/admin_syarat',$data);
    ...
    public function syarat1()
    {
        ...
        echo view('backend/syarat/input_syarat1');
        echo view('backend/layout-admin/footer');
    }
    ...
    public function create_syarat1(){
        ...
        echo view('App\Views\backend\syarat\input_syarat1',$data);
    }
    ...
    public function save_syarat1(){
        ...
        case 'insert':
            ...
            if($cek){
                ...
                return redirect()->to('backend/syarat');
            }else{
                $this->session->setFlashData('error','Data Gagal Disimpan');
                return redirect()->to('backend/syarat/syarat1');
            }
            break;
        case 'update':
            ...
            if($cek){
                ...
                return redirect()->to('backend/syarat/edit_syarat1');
            }
            break;
        }       
    }
    ...
    public function syarat2()
    {
        ...
        echo view('backend/layout-admin/header',$data);
        echo view('backend/syarat/input_syarat2');
        echo view('backend/layout-admin/footer');
    }
    ...
    public function create_syarat2(){
        ...
        echo view('App\Views\backend\syarat\input_syarat2',$data);
    }
    ...
    public function save_syarat2(){
        ...
        case 'insert':
            ...
            if($cek){
                ...
                $this->session->setFlashData('error','Data Gagal Disimpan');
                return redirect()->to('backend/syarat/syarat2');
            }
            break;
        case 'update':
            ...
            if($cek){
                ...
                $this->session->setFlashData('error','Data Gagal DiUbah');
                return redirect()->to('backend/syarat/edit_syarat2');
            }
            break;
        }       
    }
    ...
    public function syarat3()
    {
        ...
        echo view('backend/layout-admin/header',$data);
        echo view('backend/syarat/input_syarat3');
        echo view('backend/layout-admin/footer');
    }
    ...
    public function create_syarat3(){
        ...
        echo view('App\Views\backend\syarat\input_syarat3',$data);
    }
    ...
    public function save_syarat3(){
        ...
        case 'insert':
            ...
            if($cek){
                ...
                $this->session->setFlashData('error','Data Gagal Disimpan');
                return redirect()->to('backend/syarat/syarat3');
            }
            break;
        case 'update':
            ...
            if($cek){
                ...
                $this->session->setFlashData('error','Data Gagal DiUbah');
                return redirect()->to('backend/syarat/edit_syarat3');
            }
            break;
        }       
    }
