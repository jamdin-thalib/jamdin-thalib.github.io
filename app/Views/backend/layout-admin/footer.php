<div class="footer-copyright-area">
    ...
    <script src="<?php echo base_url('assets/backend/js/morrisjs/morris.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/morrisjs/morris-active.js')?>"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="<?php echo base_url('assets/backend/js/sparkline/jquery.sparkline.min.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/sparkline/jquery.charts-sparkline.js')?>"></script>
    <!-- calendar JS
		============================================ -->
    <script src="<?php echo base_url('assets/backend/js/calendar/moment.min.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/calendar/fullcalendar.min.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/calendar/fullcalendar-active.js')?>"></script>
    <!-- summernote JS
		============================================ -->
    <script src="<?php echo base_url('assets/backend/js/summernote/summernote.min.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/summernote/summernote-active.js')?>"></script>
    <!-- plugins JS
		============================================ -->
    ...
    <!--  editable JS
		============================================ -->
    <script src="<?php echo base_url('assets/backend/js/editable/jquery.mockjax.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/editable/mock-active.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/editable/select2.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/editable/moment.min.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/editable/bootstrap-datetimepicker.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/editable/bootstrap-editable.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/editable/xediable-active.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/chart/jquery.peity.min.js')?>"></script>
    ...
    <!-- wizard JS
		============================================ -->
    <script src="<?php echo base_url('assets/backend/js/wizard/jquery.steps.js')?>"></script>
    <script src="<?php echo base_url('assets/backend/js/wizard/steps-active.js')?>"></script>
    <!-- plugins JS
		============================================ -->
    <script src="<?php echo base_url('assets/backend/js/plugins.js')?>"></script>
    <!-- main JS
