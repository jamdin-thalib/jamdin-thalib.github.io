                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#daftar"><i class="fa fa-pencil" aria-hidden="true"></i>Dokumen Pendafatran Peserta</a></li>
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="daftar">
                                        <div class="product-status mg-tb-15">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="product-status-wrap">
                                                            <h4> List Peserta Mendaftar</h4>
                                                            <div class="add-product">
                                                                <a href="<?php echo base_url('Admin_daftar_input')?>">Add Pendafataran</a>
                                                            </div>
                                                            <table>
                                                                <tr>
                                                                    <th>Id</th>
