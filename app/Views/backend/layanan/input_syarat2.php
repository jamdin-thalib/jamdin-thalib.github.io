...
<?= form_open('backend/seleksi_syarat/save_syarat2');?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="review-tab-pro-inner">
                        <ul id="myTab3" class="tab-review-design">
                            <li class="active"><a href="#bolmut"><i class="fa fa-pencil" aria-hidden="true"></i>Input Persyaratan Programer</a></li>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section">
                                            ...
                                            <div class="input-group mg-b-pro-edt">
                                                ...
                                                <input type="text" class="form-control" id="item" name="item" value='<?= (isset($get->item)) ? $get->item : ''; ?>' placeholder="Input Persyaratan Programer" required='required'>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="text-center mg-b-pro-edt custom-pro-edt-ds">
                                            ...
                                            <a href="<?php echo base_url('backend/seleksi_syarat')?>"><button type="button" class="btn btn-warning waves-effect waves-light" >Discard</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
