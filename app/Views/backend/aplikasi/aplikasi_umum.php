...
<?= form_open('backend/aplikasi/save_umum');?>
                                        ...
                                        <div class="row">
                                            <div class="review-content-section">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <input type="date" class="form-control" id="tgl_aplikasi1" name="tgl_aplikasi1" value='<?= (isset($get->tgl_aplikasi1)) ? $get->tgl_aplikasi1 : ''; ?>' placeholder="Tanggal Pembuatan" required='required'>
                                                </div>
                                                <label for="card-number" class="form-label">Name Aplikasi</label>
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="fa fa-desktop" aria-hidden="true"></i></span>
                                                    <input type="text" class="form-control" id="nama_aplikasi1" name="nama_aplikasi1" value='<?= (isset($get->nama_aplikasi1)) ? $get->nama_aplikasi1 : ''; ?>' placeholder="Nama Dinas Salaku Pengelola" required='required'>
                                                </div>
                                                <label for="card-number" class="form-label">Dinas Penanggung Jawab</label>
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="col">
                                                            ...
                                                            <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <select name="manual_book1" class="form-control pro-edt-select form-control-primary">
                                                        ...
                                                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="input-group mg-b-pro-edt">
                                                                <span class="input-group-addon"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span>
                                                                    <input type="file" class="form-control" id="file_manualbook1" name="file_manualbook1" value='<?= (isset($get->file_manualbook1)) ? $get->file_manualbook1 : ''; ?>' placeholder="Silahkan Melaukan Upload File" required='required'>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <select name="status_aplikasi1" class="form-control pro-edt-select form-control-primary">
                                                                <option value="">--Pilih--</option>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <select name="jenis_aplikasi1" class="form-control pro-edt-select form-control-primary">
                                                                <option value="">--Pilih--</option>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <select name="bahasa_pemograman1" class="form-control pro-edt-select form-control-primary">
                                                                <option value="">--Pilih--</option>
                                                ...
                                                <label for="card-number" class="form-label">Aplikasi Description</label>
                                                <div class="input-group mg-b-pro-edt">
