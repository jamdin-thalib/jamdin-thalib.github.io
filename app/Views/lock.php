...
<head>
    ...
    <title>Lock | jeweler - Material Admin Template</title>
    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="hpanel">
                    <div class="panel-body text-center lock-inner">
                        ...
                        <br/>
                        <h4><span class="text-success">3:43:15 PM</span> <strong>Friday, February 27, 2021</strong></h4>
        ...
        <div class="row">
            <div class="col-md-12 col-md-12 col-sm-12 col-xs-12 text-center login-footer">
                <p>Copyright &copy; 2021 <a href="">Aptika</a> All rights reserved.</p>
            </div>
        </div>
    </div>
    <!-- jquery
