...
class IonAuth extends BaseConfig{
	...
	public $defaultGroup             = 'user';           // Default group, use name
	...
	public $lockoutTime              = 120;                 /* The number of seconds to lockout an account due to exceeded attempts
																	You should not use a value below 60 (1 minute) */
	public $forgotPasswordExpiration = 7600;                /* The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
	...
	public $emailConfig = [
        ...
        // 'SMTPUser' => 'diskominfo@bolmutkab.go.id',
        // 'SMTPPass' => 'diskominfo@2022!'
        'SMTPHost' => 'smtp.googlemail.com',
        'SMTPUser' => 'ace.develop21@gmail.com',
        'SMTPPass' => '@c3develop',
	];
